...
export function Solutions() {
  ...
  return (
    <section id="especialidades" className="py-16 bg-[#f8f9fa]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {cards.map((card, idx) => (
            <div key={idx} className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-start hover:shadow-md transition-shadow">
